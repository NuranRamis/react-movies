<div align="center">
  <br />
  <img src="public/movie-app.png" alt="Moodflix Screenshot">
  <br />
...
Built with React.js for the user interface, Appwrite for the Trending Movies Algorithm, and styled with TailwindCSS, Moodflix is a website project developed to showcase my skills and experience with frontend development. Inspired by a YouTube tutorial, this project serves as a practical demonstration of my ability to implement a modern movie browsing and discovery platform using React.js. Explore Moodflix to see how I've applied these technologies to create a sleek and functional movie app.
...
```bash
git clone https://github.com/NuranRamis/react-movies.git
cd react-movies
```
